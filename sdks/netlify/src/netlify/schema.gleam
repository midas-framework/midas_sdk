...
pub type TrafficRulesAggregateConfig {
  TrafficRulesAggregateConfig(keys: Option(List(Nil)))
}
...
pub fn traffic_rules_config_encode(data: TrafficRulesConfig) {
  json.object([
    #(
      "action",
      json.nullable(data.action, fn(_) {
        panic as "Literal object inside field"
      }),
    ),
  ])
}
...
pub fn function_config_encode(data: FunctionConfig) {
  json.object([
    ...
    #(
      "build_data",
      json.nullable(data.build_data, fn(_) {
        panic as "Literal object inside field"
      }),
    ),
    #(
...
pub fn plugin_run_encode(_data: PluginRun) {
  panic as "AllOf"
}
...
pub fn site_setup_encode(_data: SiteSetup) {
  panic as "AllOf"
}
...
pub fn asset_form_encode(data: AssetForm) {
  json.object([
    ...
    #(
      "fields",
      json.nullable(data.fields, fn(_) {
        panic as "Literal object inside field"
      }),
    ),
  ])
...
pub fn split_test_setup_encode(data: SplitTestSetup) {
  json.object([
    #(
      "branch_tests",
      json.nullable(data.branch_tests, fn(_) {
        panic as "Literal object inside field"
      }),
    ),
  ])
...
pub fn deploy_files_encode(data: DeployFiles) {
  json.object([
    ...
    #(
      "functions_config",
      json.nullable(data.functions_config, fn(_) {
        panic as "Literal object inside field"
      }),
    ),
    #(
    ...
    #(
      "files",
      json.nullable(data.files, fn(_) { panic as "Literal object inside field" }),
    ),
    #("framework_version", json.nullable(data.framework_version, json.string)),
    #(
      "functions",
      json.nullable(data.functions, fn(_) {
        panic as "Literal object inside field"
      }),
    ),
...
pub fn submission_encode(data: Submission) {
  json.object([
    ...
    #(
      "data",
      json.nullable(data.data, fn(_) { panic as "Literal object inside field" }),
    ),
    #("name", json.nullable(data.name, json.string)),
...
pub fn user_encode(data: User) {
  json.object([
    ...
    #(
      "onboarding_progress",
      json.nullable(data.onboarding_progress, fn(_) {
        panic as "Literal object inside field"
      }),
    ),
...
pub fn service_instance_encode(data: ServiceInstance) {
  json.object([
    #(
      "config",
      json.nullable(data.config, fn(_) {
        panic as "Literal object inside field"
      }),
    ),
    #("created_at", json.nullable(data.created_at, json.string)),
    #(
      "external_attributes",
      json.nullable(data.external_attributes, fn(_) {
        panic as "Literal object inside field"
      }),
    ),
    #(
      "env",
      json.nullable(data.env, fn(_) { panic as "Literal object inside field" }),
    ),
    #("url", json.nullable(data.url, json.string)),
    #("service_path", json.nullable(data.service_path, json.string)),
...
pub fn audit_log_encode(data: AuditLog) {
  json.object([
    ...
    #(
      "payload",
      json.nullable(data.payload, fn(_) {
        panic as "Literal object inside field"
      }),
    ),
    #("id", json.nullable(data.id, json.string)),
...
pub fn site_encode(data: Site) {
  json.object([
    ...
    #(
      "processing_settings",
      json.nullable(data.processing_settings, fn(_) {
        panic as "Literal object inside field"
      }),
    ),
    #("state", json.nullable(data.state, json.string)),
    ...
    #(
      "capabilities",
      json.nullable(data.capabilities, fn(_) {
        panic as "Literal object inside field"
      }),
    ),
    ...
    #(
      "default_hooks_data",
      json.nullable(data.default_hooks_data, fn(_) {
        panic as "Literal object inside field"
      }),
    ),
...
pub fn build_status_encode(data: BuildStatus) {
  json.object([
    ...
    #(
      "minutes",
      json.nullable(data.minutes, fn(_) {
        panic as "Literal object inside field"
      }),
    ),
  ])
