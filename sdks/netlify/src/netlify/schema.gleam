...
pub type Hook {
  Hook(
    ...
    data: Option(dict.Dict(String, json.Json)),
...
pub type Form {
  Form(
    ...
    site_id: Option(String),
    fields: Option(List(dict.Dict(String, json.Json))),
    id: Option(String),
...
pub type TrafficRulesAggregateConfig {
  TrafficRulesAggregateConfig(keys: Option(List(Internal2)))
}
...
pub type AccountType {
  AccountType(
    ...
    name: Option(String),
    capabilities: Option(dict.Dict(String, json.Json)),
...
pub type Site {
  Site(
    ...
    url: Option(String),
    user_id: Option(String),
    processing_settings: Option(Internal5),
    state: Option(String),
    custom_domain: Option(String),
    build_settings: Option(RepoInfo),
    screenshot_url: Option(String),
    capabilities: Option(dict.Dict(String, dict.Dict(String, json.Json))),
    deploy_url: Option(String),
    updated_at: Option(String),
    branch_deploy_custom_domain: Option(String),
    default_hooks_data: Option(Internal6),
...
pub type ServiceInstance {
  ServiceInstance(
    config: Option(dict.Dict(String, json.Json)),
    created_at: Option(String),
    external_attributes: Option(dict.Dict(String, json.Json)),
    env: Option(dict.Dict(String, json.Json)),
    url: Option(String),
    service_path: Option(String),
    service_name: Option(String),
    service_slug: Option(String),
    snippets: Option(List(dict.Dict(String, json.Json))),
    updated_at: Option(String),
...
pub type User {
  User(
    ...
    uid: Option(String),
    onboarding_progress: Option(Internal8),
...
pub type SplitTest {
  SplitTest(
    ...
    created_at: Option(String),
    name: Option(String),
    branches: Option(List(dict.Dict(String, json.Json))),
    site_id: Option(String),
    updated_at: Option(String),
    id: Option(String),
...
pub type DeployFiles {
  DeployFiles(
    ...
    function_schedules: Option(List(FunctionSchedule)),
    files: Option(dict.Dict(String, json.Json)),
    framework_version: Option(String),
    functions: Option(dict.Dict(String, json.Json)),
    async: Option(Bool),
    framework: Option(String),
  )
}
...
pub type SplitTestSetup {
  SplitTestSetup(branch_tests: Option(dict.Dict(String, json.Json)))
}
...
pub type Service {
  Service(
    ...
    icon: Option(String),
    events: Option(List(dict.Dict(String, json.Json))),
...
pub type FunctionConfig {
  FunctionConfig(
    ...
    build_data: Option(dict.Dict(String, json.Json)),
...
pub type TrafficRulesConfig {
  TrafficRulesConfig(action: Option(Internal12))
}
...
pub type SiteFunction {
  SiteFunction(
    ...
    id: Option(String),
    functions: Option(List(dict.Dict(String, json.Json))),
  )
}
...
pub type Internal4 {
  Internal4(pretty_urls: Option(Bool))
}

pub type Internal5 {
  Internal5(html: Option(Internal4))
}

pub type Internal6 {
  Internal6(access_token: Option(String))
}
...
pub type Internal7 {
  Internal7(
    ...
    additional_properties: dict.Dict(String, dict.Dict(String, json.Json)),
  )
}

pub type Internal8 {
  Internal8(slides: Option(String))
}

pub type Internal9 {
  Internal9(repo: Option(RepoInfo))
}

pub type Internal10 {
  Internal10(deploy_id: Option(String))
}
...
pub type Internal12 {
  Internal12(config: Option(Internal11), type_: Option(String))
}
...
pub fn internal_12_decoder() {
  ...
  decode.success(Internal12(config: config, type_: type_))
}

pub fn internal_12_encode(data: Internal12) {
  utils.object([
    #("config", json.nullable(data.config, internal_11_encode)),
...
pub fn internal_10_decoder() {
  ...
  decode.success(Internal10(deploy_id: deploy_id))
}

pub fn internal_10_encode(data: Internal10) {
  utils.object([#("deploy_id", json.nullable(data.deploy_id, json.string))])
}
...
pub fn internal_9_decoder() {
  ...
  decode.success(Internal9(repo: repo))
}

pub fn internal_9_encode(data: Internal9) {
  utils.object([#("repo", json.nullable(data.repo, repo_info_encode))])
}
...
pub fn internal_8_decoder() {
  ...
  decode.success(Internal8(slides: slides))
}

pub fn internal_8_encode(data: Internal8) {
  utils.object([#("slides", json.nullable(data.slides, json.string))])
}
  ...
  utils.object([
    ...
    ..dict.to_list(
      dict.map_values(data.additional_properties, fn(_key, value) {
        utils.dict(_, fn(data) { data })(value)
      }),
    )
  ])
}
...
pub fn internal_6_decoder() {
  ...
  decode.success(Internal6(access_token: access_token))
}
...
pub fn internal_5_decoder() {
  ...
  decode.success(Internal5(html: html))
}

pub fn internal_5_encode(data: Internal5) {
  utils.object([#("html", json.nullable(data.html, internal_4_encode))])
}
...
pub fn internal_4_decoder() {
  ...
  decode.success(Internal4(pretty_urls: pretty_urls))
}

pub fn internal_4_encode(data: Internal4) {
  utils.object([#("pretty_urls", json.nullable(data.pretty_urls, json.bool))])
}
...
pub fn internal_3_decoder() {
  ...
  decode.success(Internal3(card_type: card_type, email: email, last4: last4))
}
...
pub fn internal_2_decoder() {
  ...
  decode.success(Internal2(type_: type_))
}

pub fn internal_2_encode(data: Internal2) {
  utils.object([#("type", json.nullable(data.type_, json.string))])
}
...
pub fn internal_1_decoder() {
  ...
  decode.success(Internal1(sites: sites, collaborators: collaborators))
}
...
pub fn site_function_decoder() {
  ...
  use functions <- decode.optional_field(
    ...
    None,
    decode.optional(
      decode.list(decode.dict(decode.string, utils.dynamic_to_json())),
    ),
  )
  decode.success(SiteFunction(
    branch: branch,
...
pub fn site_function_encode(data: SiteFunction) {
  utils.object([
    ...
    #(
      ...
      json.nullable(
        data.functions,
        json.array(_, utils.dict(_, fn(data) { data })),
      ),
    ),
  ])
}
...
pub fn traffic_rules_config_encode(data: TrafficRulesConfig) {
  utils.object([#("action", json.nullable(data.action, internal_12_encode))])
}
...
pub fn env_var_encode(data: EnvVar) {
  utils.object([
    #("values", json.nullable(data.values, json.array(_, env_var_value_encode))),
...
pub fn function_config_encode(data: FunctionConfig) {
  utils.object([
    ...
    #(
      "build_data",
      json.nullable(data.build_data, utils.dict(_, fn(data) { data })),
    ),
    #(
      "excluded_routes",
      json.nullable(data.excluded_routes, json.array(
        _,
        excluded_function_route_encode,
      )),
    ),
  ])
}
...
pub fn plugin_run_decoder() {
  ...
  use e1 <- decode.then(internal_10_decoder())
  decode.success(#(e0, e1))
}

pub fn plugin_run_encode(data: PluginRun) {
  utils.merge([plugin_run_data_encode(data.0), internal_10_encode(data.1)])
}
...
pub fn site_setup_decoder() {
  ...
  use e1 <- decode.then(internal_9_decoder())
  decode.success(#(e0, e1))
}

pub fn site_setup_encode(data: SiteSetup) {
  utils.merge([site_encode(data.0), internal_9_encode(data.1)])
}
...
pub fn dns_record_create_decoder() {
  ...
  use tag <- decode.optional_field("tag", None, decode.optional(decode.string))
  decode.success(DnsRecordCreate(
    port: port,
    priority: priority,
    ttl: ttl,
    flag: flag,
...
pub fn split_test_setup_encode(data: SplitTestSetup) {
  utils.object([
    #(
      "branch_tests",
      json.nullable(data.branch_tests, utils.dict(_, fn(data) { data })),
    ),
  ])
}
...
pub fn deploy_files_decoder() {
  ...
  use async <- decode.optional_field(
    "async",
    None,
    decode.optional(decode.bool),
  )
...
pub fn deploy_files_encode(data: DeployFiles) {
  utils.object([
    ...
    #(
      "functions_config",
      json.nullable(data.functions_config, utils.dict(_, function_config_encode)),
    ),
    #(
      "function_schedules",
      json.nullable(data.function_schedules, json.array(
        _,
        function_schedule_encode,
      )),
    ),
    #("files", json.nullable(data.files, utils.dict(_, fn(data) { data }))),
    #("framework_version", json.nullable(data.framework_version, json.string)),
    #(
      "functions",
      json.nullable(data.functions, utils.dict(_, fn(data) { data })),
    ),
...
pub fn function_schedule_decoder() {
  ...
  use cron <- decode.optional_field(
    "cron",
    None,
    decode.optional(decode.string),
  )
...
pub fn account_update_member_setup_decoder() {
  ...
  decode.success(AccountUpdateMemberSetup(
    site_ids: site_ids,
    role: role,
...
pub fn submission_encode(data: Submission) {
  utils.object([
    ...
    #("created_at", json.nullable(data.created_at, json.string)),
    #("data", json.nullable(data.data, utils.dict(_, fn(data) { data }))),
    #("name", json.nullable(data.name, json.string)),
...
pub fn user_encode(data: User) {
  utils.object([
    ...
    #(
      "onboarding_progress",
      json.nullable(data.onboarding_progress, internal_8_encode),
    ),
...
pub fn service_instance_decoder() {
  ...
  use id <- decode.optional_field("id", None, decode.optional(decode.string))
  decode.success(ServiceInstance(
    config: config,
    created_at: created_at,
...
pub fn service_instance_encode(data: ServiceInstance) {
  utils.object([
    #("config", json.nullable(data.config, utils.dict(_, fn(data) { data }))),
    #("created_at", json.nullable(data.created_at, json.string)),
    #(
      "external_attributes",
      json.nullable(data.external_attributes, utils.dict(_, fn(data) { data })),
    ),
    #("env", json.nullable(data.env, utils.dict(_, fn(data) { data }))),
    #("url", json.nullable(data.url, json.string)),
    #("service_path", json.nullable(data.service_path, json.string)),
...
pub fn audit_log_encode(data: AuditLog) {
  utils.object([
    #("account_id", json.nullable(data.account_id, json.string)),
    #("payload", json.nullable(data.payload, internal_7_encode)),
    #("id", json.nullable(data.id, json.string)),
  ])
}
...
pub fn excluded_function_route_decoder() {
  ...
  decode.success(ExcludedFunctionRoute(
    literal: literal,
    pattern: pattern,
    expression: expression,
  ))
...
pub fn site_encode(data: Site) {
  utils.object([
    ...
    #(
      "processing_settings",
      json.nullable(data.processing_settings, internal_5_encode),
    ),
    #("state", json.nullable(data.state, json.string)),
    ...
    #(
      "default_hooks_data",
      json.nullable(data.default_hooks_data, internal_6_encode),
    ),
...
pub fn account_type_encode(data: AccountType) {
  utils.object([
    ...
    #(
      "capabilities",
      json.nullable(data.capabilities, utils.dict(_, fn(data) { data })),
    ),
    #(
      "monthly_dollar_price",
...
pub fn account_update_setup_decoder() {
  ...
  decode.success(AccountUpdateSetup(
    type_id: type_id,
    name: name,
    slug: slug,
    extra_seats_block: extra_seats_block,
...
pub fn payment_method_encode(data: PaymentMethod) {
  utils.object([
    ...
    #("created_at", json.nullable(data.created_at, json.string)),
    #("data", json.nullable(data.data, internal_3_encode)),
    #("state", json.nullable(data.state, json.string)),
    #("updated_at", json.nullable(data.updated_at, json.string)),
    #("type", json.nullable(data.type_, json.string)),
    #("id", json.nullable(data.id, json.string)),
...
pub fn traffic_rules_aggregate_config_encode(data: TrafficRulesAggregateConfig) {
  utils.object([
    #("keys", json.nullable(data.keys, json.array(_, internal_2_encode))),
  ])
}
...
pub fn account_membership_decoder() {
  ...
  decode.success(AccountMembership(
    type_id: type_id,
    payment_method_id: payment_method_id,
...
pub fn account_membership_encode(data: AccountMembership) {
  utils.object([
    ...
    #("capabilities", json.nullable(data.capabilities, internal_1_encode)),
    #("updated_at", json.nullable(data.updated_at, json.string)),
    #("billing_email", json.nullable(data.billing_email, json.string)),
    #("type", json.nullable(data.type_, json.string)),
    #("id", json.nullable(data.id, json.string)),
...
pub fn traffic_rules_rate_limit_config_decoder() {
  ...
  decode.success(TrafficRulesRateLimitConfig(
